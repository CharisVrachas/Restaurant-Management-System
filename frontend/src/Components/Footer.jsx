      ...
      <div className='flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6'>
        ...
        <div>
          <ul className='flex gap-6 justify-center text-gray-700 text-base font-medium'>
            <li className='cursor-pointer hover:text-amber-500' onClick={() => scrollToSection('home')}>Home</li>
            <li className='cursor-pointer hover:text-amber-500' onClick={() => scrollToSection('reservations')}>Reservation</li>
            <li className='cursor-pointer hover:text-amber-500' onClick={() => scrollToSection('menu')}>Menu</li>
          </ul>
        </div>
      </div>

      <p className='text-center text-sm text-gray-500 mt-4'> © 2025 Restaurant. All rights reserved.</p>
    </div>
  )
}
